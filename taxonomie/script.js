document.addEventListener('DOMContentLoaded', () => {
  ...
  const LEX = [
    ...
    { t:'Sédiment', d:"Particules issues de l'érosion ou de restes d'organismes, avant de devenir une roche." },
    { t:'Éon', d:'La plus grande subdivision de l\u2019échelle des temps géologiques — regroupe plusieurs ères (ex. le Phanérozoïque).' },
  ];
